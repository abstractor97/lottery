...
(function (game) {
    ...
    var PageTopOut = (function () {
         ...
         * @platform egret3.0.2
         */
        PageTopOut.prototype.switching = function (fromPage, callBack, thisObj, params) {
            if (fromPage) {
    ...
    game.PageTopOut = PageTopOut;
    __reflect(PageTopOut.prototype, "game.PageTopOut", ["game.IPanelSwitch"]);
})(game || (game = {}));
